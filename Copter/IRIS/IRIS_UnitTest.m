% IRIS_UnitTest implements test functions for the models
% based in the IRIS Quadcopter in Multicopter library
%
...
%
%   example call: rt = table(runtests('IRIS_UnitTest'))
%
% Literature: 
...
function tests = IRIS_UnitTest
    addPathIris;
    tests = functiontests(localfunctions);
end

function Test_IRIS_ArduPilot_SITL(testCase)

validateModelBuild('init_quadcopter_IRIS_ArduPilot_SITL');
